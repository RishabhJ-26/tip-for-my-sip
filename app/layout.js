...
export const metadata = {
  title: "Tip For My Sip - Fund your projects with chai",
  description: "Tip For My Sip is a vintage-inspired crowdfunding platform where fans support creators with small tips — like buying them a chai.",
};
