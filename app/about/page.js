...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4">About Tip For My Sip</h1>
            <p className="text-lg mb-6">
                Tip For My Sip is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a chai. Unlock the potential of your fanbase and bring your projects to life.
            </p>
  ...
  <p className="text-base">Created with passion by <span className="font-semibold text-blue-400"><a href="http://linkedin.com/in/rishabh-jain-enris">Rishabh Jain</a></span></p>
</div>
